    ...
    return (
        <section className="mt-20 md:mt-16 mx-auto">
            <div className="max-w-6xl mx-auto px-3 h-full">
                <div className="ring-3 ring-my-blue rounded-4xl md:rounded-[60px] p-7 md:p-12 grid gap-4 md:gap-1  grid-cols-1 md:grid-cols-[2fr_1fr]">
                    <div className="flex flex-col gap-7">
                        ...
                        <div className="flex flex-col md:flex-row gap-3">
                            <button className="font-semibold transition-all duration-300 hover:cursor-pointer rounded-3xl px-6 py-3 md:px-8 md:py-5 bg-my-deep-green  text-my-white hover:text-my-deep-green hover:scale-105 hover:bg-my-white hover:ring hover:ring-my-deep-green/40 flex gap-3 items-center" ><span>Claim Offer Now</span> <span><Image src="/images/power.png" alt="" width={13} height={13} /></span></button>
                            <button className="font-semibold transition-all duration-300 hover:cursor-pointer rounded-3xl px-6 py-3 md:px-8 md:py-5 bg-my-white hover:scale-105 hover:bg-my-white ring ring-my-gray/20" ><span></span> <span>Standard Price <span className="font-inter">&#8358;</span>80k/month </span></button>
                        </div>
                    </div>
